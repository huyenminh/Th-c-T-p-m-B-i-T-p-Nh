...
namespace ql_thu_vien
{
    public partial class thedocgia : Form
    {
        ...
        private void dgvthedocgia_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbmatt.Text = dgvthedocgia.CurrentRow.Cells["matt"].Value.ToString();
            cmbmadg.Text = dgvthedocgia.CurrentRow.Cells["madg"].Value.ToString();
        }
        ...
        private void butsua_Click(object sender, EventArgs e)
        {
          ...
          Thedocgia tdg = new Thedocgia();
            ...
            tdg.matt = cmbmatt.Text;
            tdg.madg = cmbmadg.Text;
